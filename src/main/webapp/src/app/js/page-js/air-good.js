define(['css!style/p2-style', 'css!style/air-number', 'css!style/page-css/air-good', 'html!pages/air-cat/air-good.html', 'restAPI', 'pageManager'], function (c1, c2, c3, html, restAPI, pageManager) {
    ...
    API.airGood = {
        getChartData: {
            url: 'p2/src/main/webapp/dist/getChartData.json',
            param: ['moduleId', 'pkId', 'date']
        },
        getColumnData: {
            url: 'getColumnData.action',
            param: ['moduleId', 'pkId']
        }
    };
...
// 基于准备好的dom，初始化echarts实例
    var myfirstChart = echarts.init($('.air-good #first-echart-box')[0]);
// 指定图表的配置项和数据
    pageManager.ajaxManager({
        //hostIndex: 2,
        url: API.airGood.getChartData.url,
        data: {moduleId: '90'},
        type: 'get',
...
//		第二个柱状图
    var mynextChart = echarts.init($('.air-good #next-echart-box')[0]);
