define(['css!style/p2-style', 'css!style/air-number', 'css!style/page-css/air-bad', 'html!../../../../../../pages/air-cat/air-bad.html', 'pageManager'], function (c1, c2, c3, html, pageManager) {

    pageManager.initPage(html, 'air-bad');

    // 基于准备好的dom，初始化echarts实例
    var myfirstChart = echarts.init($('.air-bad #first-echart-box')[0]);
// 指定图表的配置项和数据
...
//		第二个柱状图
    var mynextChart = echarts.init($('.air-bad #next-echart-box')[0]);
