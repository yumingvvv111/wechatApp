define(function (require) {
    var module = {};
    var xTemplate = {};
    xTemplate.dialog = require('text!component/dialog.html');
    xTemplate.select = require('text!component/select.html');
    xTemplate.toast = require('text!component/toast.html');
